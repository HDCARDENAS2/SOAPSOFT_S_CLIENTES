...
// Generated 19/11/2017 11:26:46 PM by Hibernate Tools 4.3.1
...
public class TbClientes  implements java.io.Serializable {
    ...
    public TbClientes(String nit, String razonSocial, String telefono, String celular, int contacto, boolean estado, String direccion, String creadoPor, Date creadoEn, String modificadoPor, Date modificadoEn) {
       this.nit = nit;
       this.razonSocial = razonSocial;
       this.telefono = telefono;
       this.celular = celular;
    ...
    @Column(name="modificadoEn", length=10)
